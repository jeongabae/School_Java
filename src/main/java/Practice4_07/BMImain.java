...
public class BMImain {
    public static void main(String[]args){
        ...
        BMI bmi1 = new BMI(scanner.next(), scanner.nextInt(), scanner.nextDouble(), scanner.nextDouble()); //user1 information

        System.out.print("Enter: name2, age2, weight2(kg), height2(cm) : "); //User2 Information Input Guide
        BMI bmi2 = new BMI(scanner.next(), scanner.nextInt(), scanner.nextDouble(), scanner.nextDouble()); //user2 information
